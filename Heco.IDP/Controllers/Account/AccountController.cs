...
namespace Heco.IDP.Controllers.Account
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
        ...
        private IHecoUserRepository _hecoUserRepository { get; set; }
        ...
        public AccountController(
            ...
            IHecoUserRepository hecoUserRepository)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_hecoUserRepository.AreUserCredentialsValid(model.Username, model.Password))
                {
                    var user = _hecoUserRepository.GetUserByUsername(model.Username);
            ...
            AdditionalAuthenticationFactorViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await HttpContext.AuthenticateAsync("idsrv.2FA");

                var tempUser = result?.Principal;
                if (tempUser == null)
                {
                    throw new Exception("2FA error");
                }

                var user = _hecoUserRepository.GetUserBySubjectId(tempUser.GetSubjectId());
